...
public class Conn_Pool_H2_CONN_TO_DATABASE {
    
	public static void main(String[] args) {	
		Connection con=null;
		Statement st=null;
		JdbcConnectionPool	bs=null;
		ResultSet rs=null;
		try {
			//Create DataSource object Represention Empty JDBC Conn POOL
			// register  JDBC driver s/w
			 Class.forName("oracle.jdbc.driver.OracleDriver");
			bs=JdbcConnectionPool.create("jdbc:oracle:thin:@localhost:1521:ORCL","scott","tiger");
			if(bs!=null){
			//Set JDBC Properties to DataSource Object to Create Conn Object in the conn pool
		//	bs_DRIVE("oracle.jdbc.driver.OracleDriver");
